...
const accounts = [
  // Metamask account
  "0x308ba7bd8ff091b9cd88f3f7fefb1e77d66933557adb73046a7a06c9bc607026",
  // Ganache first account
  "0x050fa1276007cd1343975410f321c39754fc20118ce8cdc7eabb3c78a70bcdfc",
  // Tenderly
  "0x5db9b9176b10b97eb40561a4f1f6e8718e61a027b9078e862beaa4478fbaaf90"
];

const addresses = [
  // Tenderly
  "0x91908A36f5995c08938A99ddaD841162ccb9C6d9"
]

const mnemonics = [
  // Tenderly
  "kitten click empower spend pulse fox stairs genuine name sort rifle pitch"
]
...
const config: HardhatUserConfig = {
  ...
  networks: {
    ...
    tenderly: {
      url: "https://virtual.mainnet.rpc.tenderly.co/74b95942-111d-45cf-8471-0317019ec881",
      chainId: 1,
    },
    // devnet: {
